...
// rental income add
  ...
  const personalLoanAdd = document.querySelector(
    ".personal-loan .add-new"
  );
  ...
  personalLoanAdd.addEventListener('click', (e) => {
    ...
    if (personalLoanBank.value &&  personalLoanOutstanding.value && personalLoanInstallment.value) {
      personalLoanList.push({
        bank: personalLoanBank.value,
        outstanding: personalLoanOutstanding.value, installment: personalLoanInstallment.value
      })
      personalLoanEntries.insertAdjacentHTML('beforeend', AddTemplate(personalLoanBank.value, personalLoanOutstanding.value, personalLoanInstallment.value))
  ...
  const homeLoanAdd = document.querySelector(
    ".home-loan .add-new"
  );
  const homeLoanList = [];
  ...
  homeLoanAdd.addEventListener('click', (e) => {
    ...
    if (homeLoanBank.value &&  homeLoanOutstanding.value && homeLoanInstallment.value) {
      homeLoanList.push({
        bank: homeLoanBank.value,
        outstanding: homeLoanOutstanding.value, installment: homeLoanInstallment.value
      })
      homeLoanEntries.insertAdjacentHTML('beforeend', AddTemplate(homeLoanBank.value, homeLoanOutstanding.value, homeLoanInstallment.value))
      homeLoanBank.value = '';
  ...
  const creditCardLimit = document.querySelector(
    ".credit-card .card-limit"
  );
 
  const creaditCardAdd = document.querySelector(
    ".credit-card .add-new"
  );
  ...
  creaditCardAdd.addEventListener('click', (e) => {
    ...
    if (creditCardLimit.value && creditCardBank.value) {
      ...
      creditCardEntries.insertAdjacentHTML('beforeend', `
  ...
  const autoLoanAdd = document.querySelector(
    ".auto-loan .add-new"
  );
  const autoLoanList = [];
  ...
  autoLoanAdd.addEventListener('click', (e) => {
    ...
    if (autoLoanBank.value &&  autoLoanOutstanding.value && autoLoanInstallment.value) {
      autoLoanList.push({
